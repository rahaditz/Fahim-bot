...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		const fs = require("fs");
		return api.sendMessage("╭──────•◈•───────╮\n    𝗘𝘃𝗲𝗿𝘆𝗼𝗻𝗲       \nবাচ্ছা'রা চলে এসেছি আমি ফাহিম‌ বট তোমাদের মাঝে_🤭 \n╰──────•◈•───────╯", event.threadID, () => api.sendMessage({body:`________আসসালামু আলাইকুম___________
  
🤖𝗥𝗢𝗕𝗢𝗧 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟𝗟🤖
  
চলে আসলাম তোমাদের মাঝে 🥀

◑আপনাকে অনেক ধন্যবাদ আমাকে এড দেওয়ার জন্য,❤️‍🔥

◑কিন্তু আমাকে কন্ট্রোল করার জন্য প্রয়োজন আমার বস ফাহিম চৌধুরী কে🤙

◑মেম্বারদের সব কমান্ড আমার পক্ষে পালনকরা সম্ভব না 😔

◑আমার বস ফাহিম চৌধুরী কে এড দিতে প্রথমে টাইপ করুন /adduser তারপর একটা স্পেস দিয়ে বস এর 𝒖𝒊'𝒅 100029901980367 দিন ☺️

◑ 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 ☞ https://www.facebook.com/FahimChowdury006?mibextid=ZbWKwL

◑ 𝗪𝗛𝗔𝗧'𝗦 𝗔𝗣𝗣 ☞ wa.me/+8801315086453 🐰😗

◑ 𝗧𝗔𝗟𝗘𝗚𝗥𝗔𝗠 ☞ FahimChowdhury143
...
`, attachment: fs.createReadStream(__dirname + "/Alvi/joinmp4/alvi.mp4")} ,threadID));
		...
		try {
			...
			const randomPath = readdirSync(join(__dirname, "Alvi", "join.gif", "randomgif"));
